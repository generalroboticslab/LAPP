...
from repo.unitree_rl_gym.legged_gym.utils import get_args, task_registry_pref
...
def main():
    ...
    task_registry_pref.register(args.task, LLMPrefGo2RobotFlat, env_cfg, LLMPrefGo2RobotFlatCfgPPO)
    # env, env_cfg = task_registry.make_env(name=args.task, args=args, env_cfg=env_cfg)
    env, env_cfg = task_registry_pref.make_env(name=args.task, args=args)

    # Proceed with training
    ppo_runner, train_cfg = task_registry_pref.make_alg_runner(
