...
class PureGo2Cfg(BaseConfig):
    class env:
        num_envs = 4096
        num_observations = 47  # 47
        num_privileged_obs = 50  # 50 if not None a priviledge_obs_buf will be returned by step() (critic obs for assymetric training). None is returned otherwise
        num_actions = 12
...
class PureGo2CfgPPO(BaseConfig):
    seed = 1
