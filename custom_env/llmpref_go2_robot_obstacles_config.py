...
class LLMPrefGo2ObstaclesCfg(BaseConfig):
    class env:
        num_envs = 4096
        num_observations = 48
        ...
        test = False
        # =============================================
        reward_module_name = 'llmhydra_prompt2.record.llm_go2_reward'
        ...
        pref_buf_interval = 100  # train the preference reward predictor every after this number of episode, must be the same as the save_interval in the ppo config. Should check this before run the learning.
        num_pref_pairs_per_episode = 1
        # =============================================
    ...
    class init_state:
        # =============================================
        pos = [0.0, 0.0, 0.3]  # x,y,z [m]  [0.0, 0.0, 0.42]
...
class LLMPrefGo2ObstaclesCfgPPO(BaseConfig):
    seed = 1
