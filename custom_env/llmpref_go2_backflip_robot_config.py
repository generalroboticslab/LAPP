...
# modified from class LLMHydra2Go2RobotCfg and add things from class LLMHydra2Go2Light2RobotCfg
class LLMPrefGo2BackflipRobotCfg(BaseConfig):
    class env:
...
class LLMPrefGo2BackflipRobotCfgPPO(BaseConfig):
    seed = 1
    ...
    class runner:
        ...
        experiment_name = 'gpt_go2_normal'
        run_name = ''
        # load and resume
        resume = False
