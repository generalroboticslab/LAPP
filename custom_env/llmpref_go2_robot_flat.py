...
from .llmpref_go2_robot_flat_config import LLMPrefGo2RobotFlatCfg
...
class LLMPrefGo2RobotFlat(BaseTask):
    def __init__(self, cfg: LLMPrefGo2RobotFlatCfg, sim_params, physics_engine, sim_device, headless):
    ...
    def step(self, actions):
        ...
        self.unclipped_actions = actions
    ...
    def compute_observations(self):
        ...
        # print(f"obs_scales.lin_vel: {self.obs_scales.lin_vel}")
        # print(f"base_ang_vel: {self.base_ang_vel[0]}")
        # print(f"obs_scales.ang_vel: {self.obs_scales.ang_vel}")
        # print(f"projected_gravity: {self.projected_gravity[0]}")
        # print(f"commands[:, :3]: {self.commands[0, :3]}")
        # print(f"self.commands_scale: {self.commands_scale}")
        # print(f"dof_pos: {self.dof_pos[0]}")
        # print(f"default_dof_pos: {self.default_dof_pos[0]}")
        # print(f"obs_scales.dof_pos: {self.obs_scales.dof_pos}")
        # print(f"dof_vel: {self.dof_vel[0]}")
        # print(f"obs_scales.dof_vel: {self.obs_scales.dof_vel}")
        # print(f"actions: {self.unclipped_actions[0]}")
        # print(f"action clip: {self.cfg.normalization.clip_actions}")
        # print("############################")
    ...
    def _create_ground_plane(self):
        ...
        print("############################")
        print(plane_params.static_friction)
        print(plane_params.dynamic_friction)
        print("############################")
    ...
    def _create_envs(self):
        ...
        # print("###################")
        # print("the feet_names are: ", feet_names)
        # print("###################")
