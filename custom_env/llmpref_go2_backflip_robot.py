...
from .llmpref_go2_backflip_robot_config import LLMPrefGo2BackflipRobotCfg
...
# similar to LLMHydra2Go2Light2JumpRobot, but has normal robot body weight

class LLMPrefGo2BackflipRobot(BaseTask):
    def __init__(self, cfg: LLMPrefGo2BackflipRobotCfg, sim_params, physics_engine, sim_device, headless):
