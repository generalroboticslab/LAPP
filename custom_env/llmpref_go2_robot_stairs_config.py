...
class LLMPrefGo2RobotStairsCfg(BaseConfig):
    class env:
        ...
        test = False
        reward_module_name = 'go2stairs_prompt.reward.go2_forward_reward'  # Default reward module
        ...
        init_difficulty_level = 0

    class terrain:
        mesh_type = 'plane'  # "heightfield" # none, plane, heightfield or trimesh
        horizontal_scale = 0.1  # [m]
        vertical_scale = 0.01  # [m]  originally 0.005
        border_size = 25  # [m]
        curriculum = True
        static_friction = 1.0
    ...
    class commands:
        ...
        class ranges:
            lin_vel_x = [-0.0, 2.2]  # min max [m/s]  [-1.0, 2.2] for stairs: [-0.0, 1.1]
...
class LLMPrefGo2RobotStairsCfgPPO(BaseConfig):
    seed = 1
