...
# mode 0: state(15 + 1 + 4), 1: obs(48), 2: state(15 + 1 + 4)+action(12), 3: obs(48)+action(12), 4: state(15 + 1 + 4)+obs(48)+action(12)
...
class PrefPredTransformerStairsTrain:
    def __init__(self, org_data: dict, device, save_models_path, save_models=True, pool_models_num=5, select_models_num=3, input_mode=0,
