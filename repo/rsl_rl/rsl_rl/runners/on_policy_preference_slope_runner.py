...
from rsl_rl.algorithms import PrefPredTransformerSlopeTrain
...
class OnPolicyPrefSlopeRunner:
    ...
    def __init__(self,
        ...
        if env.cfg.terrain.terrain_type == 'curriculum_slope':
            self.init_system_file_path = self.project_root / 'go2slope_prompt/slope_forward_initialize_system.txt'
        else:
    ...
    def curr_learn_w_pred(self, num_learning_iterations, main_args, init_at_random_ep_len=False):
        ...
        for it in range(self.current_learning_iteration, tot_iter):
            ...
            if it % main_args.pref_pred_update_period_eps == 0 and it > 0:
                ...
                pref_pred_trainer = PrefPredTransformerSlopeTrain(org_data=pref_train_data,
                                                              device=self.device,
